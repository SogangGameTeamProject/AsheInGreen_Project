...
public class EndGameManager : Singleton<EndGameManager>
{
    ...
    [SerializeField]
    private CharacterConfig[] m_charactersData;         // The characters data use to take some data from there
    ...
    private PlayerScore m_bestPlayer;               // Catch who is the best player -> only on server
