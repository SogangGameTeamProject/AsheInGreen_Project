...
namespace AshGreen.Item
{
    public class ItemSelectManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private ItemData healItemData;//회복 아이템 데이터
        ...
        private void OnEnable()
        {
            ...
            List<ItemData> randomItemDataList = itemDataList.GetRandomItems(m_btnControllerList.Count-1);

            randomItemDataList.Insert(0, healItemData);// 회복 아이템 추가
